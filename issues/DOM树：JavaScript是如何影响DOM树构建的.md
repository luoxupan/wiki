本文我们介绍 DOM 树是怎么生成的。然后再基于 DOM 树的解析流程介绍两块内容：第一个是在解析过程中遇到 JavaScript 脚本，DOM 解析器是如何处理的？第二个是 DOM 解析器是如何处理跨站点资源的？
...
![image](https://user-images.githubusercontent.com/7278711/124226495-cb949d80-db3b-11eb-9d76-27bf7ac99de4.png)
...
![image](https://user-images.githubusercontent.com/7278711/124226591-f3840100-db3b-11eb-896f-8930d670b74d.png)
...
![image](https://user-images.githubusercontent.com/7278711/124226796-3f36aa80-db3c-11eb-93e7-b6c646503fad.png)

然后按照同样的流程解析出来 StartTag body 和 StartTag div，其 Token 栈和 DOM 的状态如下图所示：

![image](https://user-images.githubusercontent.com/7278711/124226854-51b0e400-db3c-11eb-9dd7-6b5fff4df509.png)

接下来解析出来的是第一个 div 的文本 Token，渲染引擎会为该 Token 创建一个文本节点，并将该 Token 添加到 DOM 中，它的父节点就是当前 Token 栈顶元素对应的节点，如下图所示：

![image](https://user-images.githubusercontent.com/7278711/124226906-67bea480-db3c-11eb-912f-368dc724cb8b.png)

再接下来，分词器解析出来第一个 EndTag div，这时候 HTML 解析器会去判断当前栈顶的元素是否是 StartTag div，如果是则从栈顶弹出 StartTag div，如下图所示

![image](https://user-images.githubusercontent.com/7278711/124226952-79a04780-db3c-11eb-8747-2412e02f0371.png)

按照同样的规则，一路解析，最终结果如下图所示：

![image](https://user-images.githubusercontent.com/7278711/124226993-8755cd00-db3c-11eb-9655-783d5aae9e30.png)
...
![image](https://user-images.githubusercontent.com/7278711/124227115-b8360200-db3c-11eb-95ef-20d22238cae2.png)
